...
class SignUpForm(FlaskForm):
    ...
    firstname = StringField("firstname : ", [validators.InputRequired()] , render_kw={"placeholder": "enter your firstname"})
    lastname = StringField("lastname : ", [validators.InputRequired()] , render_kw={"placeholder": "enter your lastname"})
